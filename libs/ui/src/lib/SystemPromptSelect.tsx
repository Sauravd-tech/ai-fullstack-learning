  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <select 
        ...
        className="bg-bgSecondary text-textMain border border-borderMain px-3 py-1.5 md:py-2 rounded-lg outline-none cursor-pointer text-sm md:text-base focus:ring-2 focus:ring-brandRed/20 focus:border-brandRed transition-all shadow-sm w-[150px] md:w-[220px] truncate"
      >
